...
- Name: smoke.spec.ts >> Production smoke >> loads settings without browser errors
- Location: tests/e2e/production/smoke.spec.ts:19:7

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://inventory-app-ff-hub.vercel.app/configuracoes
Call log:
  - navigating to "https://inventory-app-ff-hub.vercel.app/configuracoes", waiting until "domcontentloaded"
